...
AppColors {
  ...
  static const LinearGradient topicsBannerGradientColors = LinearGradient(
    colors: [AppColors.mainCoralPink,AppColors.mainLavenderPurple],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
  static const LinearGradient topicsPageGradientColors = LinearGradient(
    colors: [AppColors.mainCoralPink,AppColors.mainPeachyPink],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
  static const LinearGradient hotTopicsPageGradientColors = LinearGradient(
    colors: [AppColors.mainCoralPink,AppColors.mainLavenderPurple],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
  ...
  static const LinearGradient dialogConfirmButtonColors = LinearGradient(
    colors: [mainPink, mainPetalPink],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );

  static const LinearGradient dialogCancelButtonColors = LinearGradient(
    colors: [Color(0xffF9E2E7), Color(0xffF9E2E7)],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );

  static const LinearGradient dialogDisabledButtonColor = LinearGradient(
    colors: [mainPaleGrey, mainPaleGrey],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );
  ...
  static const Color mainPink = Color(0xFFEB5D8E);//(255,235,93,1)
  static const Color mainPetalPink = Color(0xFFF08ABF);//(240, 138, 191,1)
  static const Color mainBlue = Color(0xFF2399D7);//(35, 153, 215) 52, 158, 235, 1
  ...
  static const Color mainCoralPink =  Color(0xFFFF9A7A);
  static const Color mainLavenderPurple =  Color(0xFFC279FF);
  static const Color mainPeachyPink =  Color(0xFFFFBA7A);
  static const Color mainDeepBLue =  Color(0xFF478AFB);
  ...
  static const Color tabBarBackgroundColor =  Color(0xFFEDEDED);
  static const Color missionAppBarBgColor = Color.fromRGBO(255, 218, 191, 0.8);
  static const Color globalBackgroundColor = Color(0xFFFAFAFA);
  ...
  static const Color modifyDataButtonColor = AppColors.btnDeepGrey;
  static const Color marqueeBackgroundColor = Color.fromRGBO(253, 241, 246, 1);
  static const Color marqueeImageColor =  Color.fromRGBO(236, 97, 147, 1);
  static const Color baseBackgroundColor = Color(0xffFAFAFA);
  static const Color switchActiveColor = Color.fromRGBO(255, 49, 121, 1);
  static const Color switchInactiveColor = Color.fromRGBO(207, 207, 207, 1);
  static const Color chatRoomBottomBackgroundColor = whiteBackGround;
  static const Color chatRoomFunctionIconColor = Colors.black;
  static const Color personalSettingAboutBorder = whiteBackGround;

  ///progress bar
  static const Color progressbarIndicatorColors = mainPink;//完成進度條顏色
  static const Color progressbarLineColors = Color.fromRGBO(234, 234, 234, 1);//進度條底色


  ///tag
  static const Color tagTextColors = Color.fromRGBO(236, 97, 147, 1);//標籤文字顏色
  static const Color tagBackgroundColor = Color.fromRGBO(253, 241, 246, 1);//標籤背景色
  ...
  static  LinearGradient pinkDiableGradientColors = LinearGradient(
    colors: [ Color.fromRGBO(249, 226, 231, 1), Color.fromRGBO(249, 226, 231, 1)],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
  ...
  static const LinearGradient buttonUnChooseGender = LinearGradient(
    colors: [
      AppColors.mainSnowWhite,
      AppColors.mainSnowWhite,
    ],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  ...
  static const LinearGradient missionBgColor = LinearGradient(
    colors:  [
      Color.fromRGBO(255, 218, 191, 0.8),
      Color.fromRGBO(255, 175, 204, 0.5),
  ...
  static const LinearGradient depositBgColor = LinearGradient(
    colors: [Colors.white, Color.fromRGBO(255, 235, 195, 0.5), Color.fromRGBO(255, 82, 70, 0.53)],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );
  ...
  static const LinearGradient benefitBgColor = LinearGradient(
    colors: [
      Color.fromRGBO(255, 82, 70, 0.53),
      Color.fromRGBO(255, 235, 195, 0.5),
      Color.fromRGBO(255, 255, 255, 0)
    ],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  ...
  static const Color benefitAppBarColor = Color.fromRGBO(255, 82, 70, 0.53);


  ///josh
  static const Color personalPercentTextColors = mainPink;//編輯資料百分比
  static const LinearGradient verifyTagBackgroundColor = pinkLightGradientColors;
  static const Color personalAudioColor = mainPink;//編輯資料百分比
  static const Color textFieldBackgroundColor = mainWhite;
  static const Color textFieldBorderColor = Color.fromRGBO(234, 234, 234, 1);
  static const Color editAudioBeginRecordTitleColor = mainWhite;
  static const Color editAudioBeginRecordHintColor = mainWhite;
  static const Color editAudioBeginRecordTimeColor = mainWhite;
  static const Color editAudioBeginRecordUnRecordIconColor= mainWhite;
  static const Color editAudioBeginRecordRecordIconColor= mainPink;
  static const Color editAudioBeginRecordUnRecordBackgroundColor= Colors.transparent;
  static const Color editAudioBeginRecordRecordBackgroundColor= Colors.transparent;
  static const Color editAudioBeginRecordIconProgressBordColor= mainPink;
  static const Color editAudioBeginRecordBackgroundColor= Color.fromRGBO(217, 217, 217, 1);
  static const Color editAudioBeginRecordBordColor= Colors.transparent;
  static const Color editAudiodTitleColor= textFormBlack;
  static const Color editAudiodTextFieldBackgroundColor= mainWhite;
  static const Color editAudiodTextFieldHintColor= textFormBlack;
  static const LinearGradient editAudioBeginRecordDoneBackgroundColor = pinkGradientColors;
  static const Color myTagColor= Color(0xffF6F6F6);
  static const Color myTagTextColor =Color(0xff444648);
  static const Color versionUpdateBackgroundColor= Color.fromRGBO(236, 97, 147, 1);
  ...
  static const LinearGradient commonLanguageButtonColor = LinearGradient(
    colors:  [
      Color.fromRGBO(235, 93, 142, 0.1),
      Color.fromRGBO(240, 138, 191, 0.1),
    ],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );

  static const Color myBubbleBackgroundColor = Color.fromRGBO(235, 94, 143, 1);
  ...
  static const LinearGradient strikeUpListMarqueeBackgroundColor = LinearGradient(
    colors:  [
      Color.fromRGBO(249, 160, 206, 0.3),
      Color.fromRGBO(249, 160, 206, 0)
    ],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
  ...
  // Chris
  static const Color benefitActiveBtnColor =  AppColors.mainPink;
  static const Color benefitUnActiveBtnColor = Color.fromRGBO(255, 234, 242, 1);
  static const Color benefitActiveTextColor = Color(0xffFFFFFF);
  static const Color benefitUnActiveTextColor = AppColors.mainPink;
  ...
  static const Color homeTabBarColor = Colors.white;
  static const Color homeTabBarUnSelect = Color(0xff7F7F7F);
  static const Color homeTabBarStrikeUpSelected = Color(0xffFD73A5);
  static const Color homeTabBarActivitySelected = Color(0xff58CE80);
  static const Color homeTabBarVideoSelected = Color(0xffab9ef2);
  static const Color homeTabBarMessageSelected = Color(0xff647DF6);
  static const Color homeTabBarProfileSelected = Color(0xffF5C370);
  static const Color descriptionTextColor = Color(0xFFE674A3);
  ...
  static const Color iconFriendsettingColor = Color.fromRGBO(68, 70, 72, 1);
  static const Color commonLanguageAddIconColor = AppColors.mainBlack;
  ...
  static const Color howToTVUnderLineColor = AppColors.mainBlue;
  ...
  static const Color giftAndBagMainColor =  Color(0xFFEC6193);
