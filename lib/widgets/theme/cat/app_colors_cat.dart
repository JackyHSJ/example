...
AppColorsCat {
  ...
  ///
  static const Color dialogBackgroundColor = Color.fromRGBO(252, 245, 234, 1);
  ...
  static const LinearGradient btnBrownColors = LinearGradient(
    colors: [
  ...
  static const LinearGradient btnWhiteBrownColors = LinearGradient(
    colors: [
      Color.fromRGBO(232, 210, 194, 1),
      Color.fromRGBO(232, 210, 194, 1)
    ],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  ...
  ///cat
  static const Color appBarBackgroundColor = Color.fromRGBO(255, 248, 235, 1);
  ...
  static const LinearGradient editAudioBeginRecordDoneBackgroundColor = btnWhiteBrownColors;
