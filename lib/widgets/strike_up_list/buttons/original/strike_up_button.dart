...
class StrikeUpButton extends StatefulWidget {
  ...
  @override
  State<StrikeUpButton> createState() => _StrikeUpButtonState();
}

class _StrikeUpButtonState extends State<StrikeUpButton> with AutomaticKeepAliveClientMixin, SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return _buildStrikeUpBtn();
  }

  Widget _buildStrikeUpBtn() {
