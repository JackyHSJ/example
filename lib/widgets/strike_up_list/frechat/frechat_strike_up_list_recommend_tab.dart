...
class FrechatStrikeUpListRecommendTab extends ConsumerStatefulWidget {

  final ScrollController scrollController;

  const FrechatStrikeUpListRecommendTab({
    super.key,
    required this.scrollController
  });

  @override
  ConsumerState<FrechatStrikeUpListRecommendTab> createState() => _FrechatStrikeUpListRecommendTabState();
}

class _FrechatStrikeUpListRecommendTabState extends ConsumerState<FrechatStrikeUpListRecommendTab> with AutomaticKeepAliveClientMixin{
