...
class StrikeUpListOnlineTab extends ConsumerStatefulWidget {

  final ScrollController scrollController;

  const StrikeUpListOnlineTab({
    super.key,
    required this.scrollController
  });

  @override
  ConsumerState<StrikeUpListOnlineTab> createState() => _StrikeUpListOnlineTabState();
}

class _StrikeUpListOnlineTabState extends ConsumerState<StrikeUpListOnlineTab> with AutomaticKeepAliveClientMixin {
