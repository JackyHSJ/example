...
import 'package:frechat/screens/profile/agent/second_agent_list/agent_tab/personal_second_agent_tab_view_model.dart';
...
class PersonalSecondAgentTab extends ConsumerStatefulWidget {
  const PersonalSecondAgentTab({super.key, required this.agentMember});
  final AgentMemberInfo agentMember;

  @override
  ConsumerState<PersonalSecondAgentTab> createState() => _PersonalSecondAgentTabState();
}

class _PersonalSecondAgentTabState extends ConsumerState<PersonalSecondAgentTab> with TickerProviderStateMixin{
  late PersonalSecondAgentTabViewModel viewModel;
  ...
  @override
  void initState() {
    viewModel = PersonalSecondAgentTabViewModel(ref: ref, setState: setState, agentMember: agentMember);
    ...
    return CustomList.separatedList(
        ...
        children: (context, index){
          ...
          return PersonalAgentMemberCell(
              ...
              mode: AgentMemberListMode.secondAgentContact,
          );
        }
    );
  }
  ...
  Widget _searchTextField() {
    final WsAgentMemberListRes? memberList = ref.read(userInfoProvider).agentSecondMemberList;
    return Padding(
