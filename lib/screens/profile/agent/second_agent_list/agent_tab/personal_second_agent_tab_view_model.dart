...
class PersonalSecondAgentTabViewModel {
  PersonalSecondAgentTabViewModel({required this.ref, required this.setState, required this.agentMember});
  ...
  init(BuildContext context) {
    ...
    secondAgentListUtil = SecondAgentListUtil(ref: ref, setState: setState, agentMember: agentMember, mode: AgentSecondAgentListMode.agent, onMessageAndSetDataToProviderFunction: (res){
      ref.read(userUtilProvider.notifier).loadAgentSecondMemberList(res);
    });
